...
MosDet_Gain_4_bands_BAF <- read.delim("/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Miscarriage_Surfdrive\ kopie/Submission/Github/4_MosaicismDetection/Refs/MosDet_Gain_4_bands_BAF.csv ", row.names=1)

options(digits = 16)

###BAF - 4 bands
Band1   <- "0.98573016511194"
Band2   <- "0.654949131059063"
Band3   <- "0.310539529906542"
Band4   <- "0.0105517696438553"
