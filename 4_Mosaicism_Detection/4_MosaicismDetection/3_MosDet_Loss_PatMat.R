...
MosDet_Loss_PatMat <- read.csv("/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Miscarriage_Surfdrive\ kopie/Submission/Github/4_MosaicismDetection/Refs/MosDet_Loss.csv", row.names=1)

options(digits = 16)

###Sample
P1value <- "0.00944740278553341"
P2value <- "0.537468487387387"
M1value <- "0.0654921169127962"
M2value <- "0.524989283632019"
