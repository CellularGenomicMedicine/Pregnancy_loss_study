...
ggsave(plot = Barplot_ConvKaryo_Normal_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_ConvKaryo_Normal_Abnormal.png")
ggsave(plot = Barplot_ConvKaryo_Normal_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_ConvKaryo_Normal_Abnormal.pdf")
ggsave(plot = Barplot_ConvKaryo_Normal_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_ConvKaryo_Normal_Abnormal.svg")
...
ggsave(plot = Barplot_ConvKaryo_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_ConvKaryo_Abnormal.png")
ggsave(plot = Barplot_ConvKaryo_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_ConvKaryo_Abnormal.pdf")
ggsave(plot = Barplot_ConvKaryo_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_ConvKaryo_Abnormal.svg")
...
Barplot_SNPHapla_Normal_Abnormal <- ggplot(data = Demographic_data_SNPHapla, aes(x=Group, fill = factor(Indication_SNPHapla, levels = Order, exclude = NULL))) +
  ...
  theme(legend.key.size = unit(0.5,'cm'), panel.background = element_blank(), 
        axis.line = element_line(colour = "black"), legend.title = element_blank()) + 
  scale_y_continuous(expand = c(0,0)) +
  geom_text(aes(label = paste0("\n", ..count..," ","(",percent(..count../91, accuracy = 0.1),")"), x = 1.35), 
            position = position_fill(vjust = 0.5), stat = "count", size = 3) +
  scale_fill_manual(values = c("Normal" = color_Normal, "Abnormal" = color_Abnormal)) +
  ylab("Proportion") +
  xlab("")
...
ggsave(plot = Barplot_SNPHapla_Normal_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_SNPHapla_Normal_Abnormal.png")
ggsave(plot = Barplot_SNPHapla_Normal_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_SNPHapla_Normal_Abnormal.pdf")
ggsave(plot = Barplot_SNPHapla_Normal_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_SNPHapla_Normal_Abnormal.svg")
...
ggsave(plot = Barplot_SNPHapla_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_SNPHapla_Abnormal.png")
ggsave(plot = Barplot_SNPHapla_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_SNPHapla_Abnormal.pdf")
ggsave(plot = Barplot_SNPHapla_Abnormal, width = 6, height = 5,
       "/Users/G10039937/Surfdrive/ClinicalGenetics/Miscarriage/Paper/1.Paper/Figures/Supplementary/Barplot_SNPHapla_Abnormal.svg")
