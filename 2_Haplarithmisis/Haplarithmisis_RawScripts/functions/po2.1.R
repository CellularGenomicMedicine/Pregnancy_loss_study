...
po2.1 <- function(Gtypes,Family,SibPattern,outPath){
	
	print("Parent of origin analysis...")
	PatGtype <- Gtypes[,grep(paste("Father_",Family,sep=""),colnames(Gtypes))]
	MatGtype <- Gtypes[,grep(paste("Mother_",Family,sep=""),colnames(Gtypes))]
