...
analyses     <- "/storage/projects/ngs/analyses/ResearchProjecten/PGT/170911_NS500313_0350_AHLYYHBGX3"
...
GC_File <- paste(analyses,Family,"GATK",paste(Family,gtype_window,"GCcontent.txt",sep="_"),sep="/")
